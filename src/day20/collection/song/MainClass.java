...
public class MainClass {
    ...
    static Set<String> songs = new HashSet<>();
    ...
    public static void insertMusic() {
        ...
        if (artists.containsKey(artist)) {
            System.out.printf("# 아티스트 %s 님이 신규등록되었습니다.\n", artist);
            artists.put(artist, (Set<String>) artists);

            //가수 검증
            String realist = String.valueOf(artists.get(artist));
            //노래 제목 입력
            System.out.print("- 곡명: ");
            String song = sc.nextLine();
            songs.add(song);
            if (artist.equals(realist)) {
            }else{
