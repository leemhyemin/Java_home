...
public class Roulette {
    ...
    public static void main(String[] args) {
        ...
        if (bulletNum > 5) {
            System.out.println("어딜 개수작이야 GAME OVER!");
            return;
        }
...
//        System.out.println("탄창: " + Arrays.toString(magazine));
        ...
        while (true) {
            ...
            */
            ...
            System.out.println("");
            System.out.println(turn_num + "번 째 턴!" + players[turn] + "의 차례");
            System.out.println("총을 돌렸습니다.");

            int fire_pos = r.nextInt(6);
            if(magazine[fire_pos] == true)
            {
                System.out.println("(⌐■_■)–︻╦╤─ 탕!!!!!!!!!!!!");
                System.out.println(players[turn] + "은(는) 꽃다운 나이에 생을 마감하였습니다.");
                break;
            }else{
                System.out.println("(´-ㅅ･)–︻╦╤─ 틱...");
                System.out.println(players[turn] + "은(는) 자신의 목숨을 부지할 수 있었습니다.");
                turn_num++;
